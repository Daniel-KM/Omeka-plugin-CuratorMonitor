 ...
 */
class CuratorMonitor_View_Helper_ItemQuickFilters extends Zend_View_Helper_Abstract
{
    /**
     * Add buttons to filter by date (year) and status fields of Curator Monitor.
     *
        ...
        if ($html) {
            $html .= '<script type="text/javascript">
                jQuery(document).ready(function () {
                    jQuery("#curator-monitor-quick-search-div").hide();
                    jQuery("#curator-monitor-quick-search").click(function () {
                        jQuery("#curator-monitor-quick-search-div").toggle(400);
                    });
                    jQuery("#curator-monitor-quick-filters-div").hide();
                    jQuery("#curator-monitor-quick-filters").click(function () {
                        jQuery("#curator-monitor-quick-filters-div").toggle(400);
                    });
                });
            </script>';
        }
